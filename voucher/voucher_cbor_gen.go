...
func (t *Voucher) MarshalCBOR(w io.Writer) error {
	...
	if err := cbg.WriteMajorTypeHeaderBuf(scratch, w, cbg.MajTextString, uint64(len("C"))); err != nil {
		return err
	}
	...
	if t.C == nil {
		...
		if err := cbg.WriteCidBuf(scratch, w, *t.C); err != nil {
			return xerrors.Errorf("failed to write cid field t.C: %w", err)
		}
	}
		...
		case "C":

			{
				...
				if b != cbg.CborNull[0] {
					...
					if err != nil {
						return xerrors.Errorf("failed to read cid field t.C: %w", err)
					}
